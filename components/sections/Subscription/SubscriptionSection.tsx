      ...
      <Container>
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <motion.div
            ...
            className="mb-8 md:mb-10 relative -mx-4 sm:-mx-8 md:-mx-20 lg:-mx-40 h-[320px] sm:h-[400px] md:h-[520px] rounded-xl md:rounded-2xl overflow-hidden cursor-pointer bg-koel-coral"
